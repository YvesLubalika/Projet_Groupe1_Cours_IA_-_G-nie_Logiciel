...
data = pd.read_csv("E:/Yves LUBALIKA FILES/UNNIVA/Cours L3 Génie Minier/Introduction à l'IA/Projet_IA_Génie_Logiciel/AirQualityUCI.CSV", sep=";", decimal=",")
data.head()
...
def page3():
    ...
    if page == "Cours Bac1 Génie Minier":
        ...
        def file_selector(base_folder='C:/Users/Yves LUBALIKA/Desktop/Projet IA Groupe/Cours_Bac1_Génie_Minier'):
        ...
        def file_selector(base_folder='C:/Users/Yves LUBALIKA/Desktop/Projet IA Groupe/Cours_Bac2_Génie_Minier'):
            # Lister les sous-dossiers dans le dossier principal
            subfolders = [f.name for f in os.scandir(base_folder) if f.is_dir()]
